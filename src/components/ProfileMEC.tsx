  ...
  return (
    <>
      <div id='MEC' className='layout absolute bottom-[-4500px] md:bottom-[-3230px] flex flex-col justify-center items-center '>
        ...
        <Reveal>
          <p className='text-center ml-[277px] mt-3 gotham w-[50%]'>Our specialist are out pride. <br /> Responsible for inspecting, maintaining, and repairing boats and their engines to ensure they are running safely and efficiently.
          </p>
        </Reveal>
      </div>
